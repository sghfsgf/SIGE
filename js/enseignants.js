...
function initialiserEnseignants() {
    ...
    // Filtres
    const filtres = [
        "filter-matricule", "filter-grade", "filter-specialite",
        "filter-departement", "filter-sifah", "filter-wadhia",
        "filter-anneeUniversitaire", "filter-genre"
    ];
...
function reinitialiserFiltres() {
    const ids = [
        "search-enseignants", "filter-matricule", "filter-grade",
        "filter-specialite", "filter-departement", "filter-sifah",
        "filter-wadhia", "filter-anneeUniversitaire", "filter-genre"
    ];
    ...
    window.enseignantsFiltresActuels = [];   // Réinitialisation explicite
    currentPage = 1;
    appliquerFiltres();
}
...
// ... [Tout le code à partir de la fonction ouvrirModalEnseignant jusqu'à la fin reste exactement le même]
...
// ... (Je n'ai pas recopié tout le reste car il n'y avait aucun changement nécessaire : modal, selects, enregistrer, supprimer, dashboard, etc.)

// ============================================================
// FIN
// ============================================================
console.log("SIGE - enseignants.js chargé correctement (avec export des données filtrées)");
